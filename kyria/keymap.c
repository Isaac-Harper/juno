...
#define _____ROW1_A_____ KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T
#define _____ROW2_A_____ KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G
#define _____ROW3_A_____ KC_LALT, KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX, XXXXXXX
#define _____ROW4_A_____ FACTORI, KC_LSPO, KC_LCTL, KC_SPC, AAD

#define _____ROW1_B_____ KC_Y, KC_U, KC_I, KC_O, KC_P, RGB_TOG
#define _____ROW2_B_____ KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOTE
#define _____ROW3_B_____ XXXXXXX, XXXXXXX, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RGB_SAI
#define _____ROW4_B_____ SAB, KC_ENT, MOUSE, KC_RSPC, KC_HOME
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { // this is fine
	...
	[_QWERTY] = LAYOUT_wrapper(
		_____ROW1_A_____, _____ROW1_B_____,
		_____ROW2_A_____, _____ROW2_B_____,
		_____ROW3_A_____, _____ROW3_B_____,
		_____ROW4_A_____, _____ROW4_B_____),
